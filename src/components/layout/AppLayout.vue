    ...
    <div class="modal" style="max-width:400px;text-align:center">
      <div class="modal-body" style="padding:2rem 1.5rem">
        ...
        <input ref="welcomeInput" v-model="welcomeName" class="form-input"
          ...
          @keydown.enter="saveWelcomeName" style="margin-bottom:.75rem" />
...
const allRoutes = [
  { path: '/dashboard',    label: 'Dashboard',    desc: 'KPIs e gráficos',          icon: icons_search.dashboard },
  { path: '/crm',          label: 'CRM',          desc: 'Kanban e leads',            icon: icons_search.crm },
  { path: '/financeiro',   label: 'Financeiro',   desc: 'Transações e pagamentos',   icon: icons_search.financeiro },
  { path: '/recorrencias', label: 'Recorrências', desc: 'Contratos mensais',         icon: icons_search.recorrencias },
  { path: '/mapa',         label: 'Mapa Mental',  desc: 'Progresso e planejamento',  icon: icons_search.mapa },
  { path: '/prospeccao',   label: 'Prospecção',   desc: 'Importar e prospectar',     icon: icons_search.search },
]
...
.collapsed .sidebar { width: 56px; min-width: 56px; }
...
/* Nav */
.sb-nav { flex: 1; overflow-y: auto; overflow-x: hidden; padding: .625rem 0; }
.sb-section { padding: 0 .5rem; margin-bottom: .5rem; }
.sb-section-label {
  font-size: .6rem; font-weight: 700; letter-spacing: .09em;
  text-transform: uppercase; color: var(--text-tertiary);
  padding: .5rem .5rem .3rem; margin: 0;
...
.sb-item {
  ...
  width: 100%; padding: .575rem .625rem;
...
.collapsed .sb-item { justify-content: center; padding: .625rem; gap: 0; }
...
.collapsed .theme-pill { flex-direction: column; width: 36px; padding: .375rem .25rem; }
...
.topbar-clear {
  ...
  color: var(--text-tertiary); padding: 0; flex-shrink: 0;
}
...
.ud-name {
  font-size: .875rem; font-weight: 600; color: var(--text-primary); white-space: nowrap;
}
.ud-role {
  font-size: .6rem; font-weight: 700; letter-spacing: .07em;
  color: var(--accent); text-transform: uppercase;
}
.ud-divider { height: 1px; background: var(--border-default); margin: .125rem 0; }
.ud-item {
  display: flex; align-items: center; gap: .625rem;
